...
main (int argc, char *argv[])
{
  ...
  std::string remote ("192.168.3.25");
  std::string localAddress ("192.168.3.23");
  std::string localGateway ("192.168.3.25");
  ...
  address.SetBase ("192.168.3.0", "255.255.255.0", "0.0.0.10");
  ...
  emu1.EnablePcap ("emu1-ping", devices1, true);
  //
